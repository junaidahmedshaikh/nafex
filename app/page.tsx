...
import { ArrowRight, Zap, Clock, Shield, BarChart3, Code, Check } from "lucide-react"
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative overflow-hidden px-4 py-20 sm:py-32 sm:px-6 lg:px-8">
        ...
        <div ref={heroRef} className="relative mx-auto max-w-3xl text-center">
          ...
          <h1 className="text-balance text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
            Test APIs with Confidence
            <br />
            <span className="text-muted-foreground">One Line. Zero Headaches.</span>
          </h1>

          <p className="text-xl text-muted-foreground mb-10 max-w-2xl mx-auto leading-relaxed">
            Nafex is the all-in-one Node.js library for automated API testing—combining security scans, performance
            benchmarks, reliability checks, and beautiful reporting into a single, beginner-friendly package.
          </p>
      ...
      <section className="px-4 py-20 sm:py-32 sm:px-6 lg:px-8 bg-card/50">
        <div className="mx-auto max-w-3xl">
          <h2 className="text-3xl sm:text-4xl font-bold mb-8">What is Nafex?</h2>
          <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
            Nafex is a complete API testing suite for developers who want to ensure their APIs are secure, performant,
            and reliable—without writing hundreds of lines of test code.
          </p>
      ...
      <section className="px-4 py-20 sm:py-32 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-6xl">
          <h2 className="text-3xl sm:text-4xl font-bold mb-16 text-center">Why Developers Love Nafex</h2>
...
await api.test('/users/1');`}</code>
      ...
      <section className="px-4 py-20 sm:py-32 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          <h2 className="text-3xl sm:text-4xl font-bold mb-6">Ready to Test with Confidence?</h2>
